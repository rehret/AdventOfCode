...
[AdventOfCodeSolution(2022, 16, 2)]
internal class Solution02 : AdventOfCodeSolution<Graph<Valve>, int>
{
    private const int TotalTimeInMinutes = 26;
    ...
    protected override int ComputeSolution(Graph<Valve> input)
    {
        ...
        var initialState = new State(input, 0, 0, 0, start, start, targetValves);
    ...
    private record State(Graph<Valve> Graph, int Minute, int FlowRate, int TotalFlow, Valve CurrentValve, Valve CurrentElephantValve, IEnumerable<Valve> RemainingValves);
}
